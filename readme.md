...
<details>
  ...
  ```sh
  apt-get update -y && apt-get upgrade -y && apt-get install curl -y && curl https://raw.githubusercontent.com/ABHIJEET6996/FileStreamBot-pro/main/script.sh -o script.sh && bash script.sh
  ```
